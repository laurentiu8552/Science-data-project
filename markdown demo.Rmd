...
# Deleted duplicates, need more reason as to why
data <- data[!duplicated(data),]


# Imputing missing product groups and categories for least possible data loss during the process
...
data <- data %>%
  ...
  # b, Define the 'product_title' vector (202 entries) -------
product_title <- c(
